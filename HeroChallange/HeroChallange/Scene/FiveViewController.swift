...
class FiveViewController: UIViewController {
    ...
    func setupUI(){
        ...
        imageMe.snp.makeConstraints { make in
            ...
            make.trailing.equalToSuperview().inset(360)
    ...
    @objc func upPressed(){
        let nc = UINavigationController(rootViewController: FiveViewController())
    ...
    @objc func leftPressed(){
        print("Congreletions!")
        let alert = UIAlertController(title: "Congratulations, you did it!", message: "You are the best!", preferredStyle: UIAlertController.Style.alert)
